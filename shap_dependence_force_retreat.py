...
plt.scatter(force_vals, shap_force_vals, color="tomato", edgecolor="k")
plt.xlabel("Force")
plt.ylabel("SHAP Value (force)")
plt.title("SHAP Force Impact for Retreat Class")
plt.grid(True)
plt.tight_layout()
plt.savefig("shap_dependence_force_retreat.png")
plt.close()
